...
import DepInsert from "./departmentInsert";
...
class Home extends Component {
    render(){
      ...
      <div class="link">
        ...
        <li class="btn btn-success"><Link id="test" to="/departmentInsert">Insert Department</Link></li>
        </ul>
        </div>
        <Routes>
          ...
          <Route path="departmentInsert" element={<DepInsert></DepInsert>} />
          </Routes>
          </BrowserRouter>
        );
